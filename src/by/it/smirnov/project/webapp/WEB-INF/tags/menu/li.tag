...
%><%@ attribute name="spanclass"  required="true" rtexprvalue="true" type="java.lang.String"
%><%
...
%><li ${menuClassActive}><a href="do?command=${command}"><span class="${spanclass}"></span>${text}</a></li>