...
public class Bank {
     ...
     *     
     */
    public void setMFO(Integer value) {
        this.mfo = value;
    }
    ...
    public Bank(String name, Integer mfo, String fullMFO, Address address, String group) {
        this.name = name;
        this.mfo = mfo;
        this.fullMFO = fullMFO;
