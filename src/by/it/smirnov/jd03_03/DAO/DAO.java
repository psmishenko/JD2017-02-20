...
import by.it.smirnov.jd03_03.bean.User;
...
public class DAO {
    ...
    private UniversalDAO<User> user;
        ...
        if (instance==null){
            synchronized (DAO.class){
                if(instance==null){
                    ...
                    instance.user = new UniversalDAO<>(User.class,"users", "id"); //UserDAO();
...
//    }
    ...
    public UniversalDAO<User> getUser() {
        return user;
    }
