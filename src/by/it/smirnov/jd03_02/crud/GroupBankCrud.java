...
import by.it.smirnov.jd03_02.bean.GroupBank;
 ...
 */
public class GroupBankCrud extends AbstractCrud<GroupBank>{
    private static final String selectSQL = "SELECT `id`, `name` FROM `groupsbanks` WHERE ID=?";
    ...
    @Override
    PreparedStatement getStatementSelectSQL(GroupBank groupBank) throws SQLException{
