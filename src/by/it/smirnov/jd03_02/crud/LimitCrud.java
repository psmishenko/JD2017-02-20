...
import by.it.smirnov.jd03_02.bean.Limit;
 ...
 */
public class LimitCrud extends AbstractCrud<Limit>{
    private static final String selectSQL = "SELECT `id`,`idgroupbank`,`fromdate`,`idopertype`,`summa`,`idvalut`,`idsysoper` FROM `limits` WHERE ID=?";
    ...
    @Override
    PreparedStatement getStatementSelectSQL(Limit limit) throws SQLException{
