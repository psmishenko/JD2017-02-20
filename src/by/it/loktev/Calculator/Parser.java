    ...
    public static Var parseAndCalc(String str2, boolean showDebug) throws CalculatorException {
        ...
        */
        ...
        if (assignToVarName!=null) {
            ...
            Log.getInstance().write(LogItemKind.LogItemKind_Calculation,"присваивание переменной "+assignToVarName+" значения выражения: '"+str2+"', рассчитанное значение: "+V);
            return null;
        }
        else{
            Log.getInstance().write(LogItemKind.LogItemKind_Calculation,"расчёт выражения: '"+str2+"', рассчитанное значение: "+V);
        }
