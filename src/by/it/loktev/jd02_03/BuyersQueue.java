...
public class BuyersQueue {
    ...
    */
    ...
    private final static PriorityBlockingQueue<Buyer> queue=new PriorityBlockingQueue<Buyer>(Dispatcher.maxBuyersPerCashier*Dispatcher.maxCashiers,buyersComparator);
