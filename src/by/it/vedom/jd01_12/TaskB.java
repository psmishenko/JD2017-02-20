...
public class TaskB {
    ...
    public static void main(String[] args) {
        ...
        String text = "Though it was winter Vadim Petrovich, the agronomist of the farm, had a busy day last Tuesday.\n" +
                ...
                "Vadim Petrovich went to the farm. It is not far from his house, so he walks there. The road was white with snow and he couldn't walk bad_path. When he came to the farm, some people wanted to see and talk to him. His working day began. At 1 o'clock he went home to have dinner. He had dinner with his wife and little daughter who does not go to school. He ate his dinner, rested a little, and went back to the farm. Vadim Petrovich had to talk to some people, to write some letters, and to do some other demo.\n" +
