...
<div id="flipkart-navbar">
    <div class="container">
        ...
        <div class="row row2">
            <div class="col-sm-2">
                <h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()">☰ Поисковик</span></h2>
                <h1 style="margin:0px;"><span class="largenav">Поисковик</span></h1>
            </div>
            <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                <div class="row">
                    <input class="flipkart-navbar-input col-xs-11" type="" placeholder="Введите название товара" name="">
