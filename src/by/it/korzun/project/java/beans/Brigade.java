...
import by.it.korzun.project.java.dao.StaffDAO;
...
public class Brigade {
    ...
    public String toString() {
        ...
        try {
            return String.format("BrigadeID - %-3d \n\t%16s\n\t" +
                    "%16s \n\t%16s \n\t%16s \n\t%16s",
                    id,
                    staffDAO.read(firstPilotID),
                    staffDAO.read(secondPilotID),
                    staffDAO.read(navigatorID),
                    staffDAO.read(radio_operatorID),
                    staffDAO.read(stewardessID)
            );
